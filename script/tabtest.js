    ...
    $(".se-pre-con").fadeIn("fast",function(){
        ...
        jQuery.ajax({
            ...
            success:function(response){
                $('#test_table').bootstrapTable('refreshOptions', {url: 'tabtestsGetTable.php'});
                $('#testmulti_table').bootstrapTable('refreshOptions', {url: 'tabtestsGetTableMulti.php'});
                $('#testtas_table').bootstrapTable('refreshOptions', {url: 'tabtestsGetTas.php'});
                return false;
            },
